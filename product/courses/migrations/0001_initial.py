    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_group_num', models.PositiveIntegerField(verbose_name='Минимальное количество участников группы')),
                ('max_group_num', models.PositiveIntegerField(verbose_name='Максимальное количество участников группы')),
            ],
            options={
                'verbose_name': 'Курс',
